...
<div class="containerone">
  ...
  <a class="ai" href="/coopenspace">Cooperacy Experience</a> is the live application of the Cooperacy model. The participants of any organization or community can enjoy a natural social system able to generate collaboration, innovation and problem solving.<br><br>
  ...
  <div class="col-md-8">
    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 text-center">
        ...
        <p>Mario Sabatino Riontino<br><i>Cooperation Services Project</i></p>
      </div>
      <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12 text-center">
