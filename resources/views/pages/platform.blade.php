...
<div class="containerone">
  ...
  <p class="base">The platform distributes the common money and resources to the ideas according to how much they are desired by the participants. Expressing their <a class="aue" href="/cooperation#diversity">preferences</a> through <a class="aue" href="/cooperation#diversity">transparent</a> votes, the common collected money goes <a class="aue" href="/integration">proportionally</a> to the ideas according to how many votes they received. Keeping it simple: people propose <i>ideas</i>, <i>votes</i> allocate the common money.</p>

  <p class="subheading center space transparency">REDISTRIBUTING PROFITS</p>
  <p class="base">Every idea is co-owned, so when it produces wealth, its profits go back to the platform collected money, in order to fund other ideas and to create a virtuous circle that slowly generates resources for <a class="aue" href="/cooperation#equivalence">everyone</a>.</p>

  <p class="subheading center space equivalence margin">A COOPERATION LEARNING ECOSYSTEM</p>
  <p class="base">An artificial intelligence will learn from all the <a class="auu" href="/research">data</a> coming from the platform and suggest, in the long run, best practices in order to help the people to realise their ideas. Moreover, the participants can communicate their happiness, so that the "deep learning ecosystem" will base its suggestions not only on data, but also on the most human, irrational and personal information of all: mood.</p>
