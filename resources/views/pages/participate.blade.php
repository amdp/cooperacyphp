...
<div class="containerone">
  ...
  <p class="base">Our main effort is to develop our <a class="aue" href="/platform">platform</a> as described in the discover section. We hope it will be ready soon. Although we have already made some testing we still have to reach 7000 members to make it appealing, dynamic and sustainable. This is our first milestone:</p>
  ...
  <p class="base">Our communication group needs new members to help with the texts, the graphics, the translations and the front end coding. If you have any of these skills and you are willing to participate please <a class="aue" href="/register">join</a> and <a class="aut" href="/contact">contact us.</a></p>

  <p class="subheading equivalence center space margin">COOPERACY CODERS</p>
  <p class="base">If we had enough coders we would need a lot less than 7000 members to support and maintain the platform. If you would like to participate in an open project in which your experience will be of great value for the group while the final output will be a human centered designed tool to foster human cooperation, we are really happy to introduce you to our <a class="aut" href="/contact">coding team</a>.</p>

  <p class="subheading equivalence center space margin">COOPERACY EDUCATION</p>
  <p class="base"><a class="aut" href="/contact">Help us</a> with the online live webinars and in preparing the materials for the courses!</p>
  ...
  As you see, we made some funny experiments. <a class="aut" href="/contact">Maybe</a> you want to test your own?<br><br>
  </p>
