...
<div id="homefade" style="opacity:0"><!--START FADING-->
  ...
  <div class="col-md-8"><!--BEGIN CONTENT-->
    ...
    <div class="row"><br>
      ...
      <br><br><br><p class="base center">Cooperacy is a no-profit scientific project aiming to spread cooperation between humans and their ecosystem.<br><br>Joining Cooperacy is important today, if we want to experience sound social ecosystems at the <a href="/aboutyou" class="ad">personal</a>, <a href="/paradox" class="af">corporate</a> and <a href="/cci" class="af">international</a> levels.</p><br><br>
